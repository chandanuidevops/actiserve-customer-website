...
import Address from '../../../components/TraderSignup/Address'
...
function Postcodes({currentActiveStep}) {
  ...
  function getStepContent(stepIndex) {
    return <Address stepValue={activeStep} setActiveStep={setActiveStep} />
  }
  ...
  return (
    <>
      <HelmetComponent
        title={`UrbanServe | Sign Up - Postcode Coverage`}
        ogTitle={`UrbanServe | Sign Up - Postcode Coverage`}
      ...
      <StepperTrader
        stepNum={3}
        activeStep={['postcodes']}
        completeStep={['register', 'info']}
      />
      <div>
...
export default compose(withConnect)(Postcodes)
