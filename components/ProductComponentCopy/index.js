                            ...
                            {dropDownQuestions[0] !== '' &&
                              ...
                              dropDownQuestions[0].answers.map((ele, i) => (
                                <MenuItem
                                  ...
                                  className={classes.textCapitalize}
                                  onClick={() => {
                                    onSelectAnswer(ele, dropDownQuestions[0])
                                    setSelectedManufacture(ele?.answer_title)
                                  }}
                                >
                                  {ele?.answer_title}
                                </MenuItem>
                            ...
                            {dropDownNextQuestion !== '' &&
                              ...
                              dropDownNextQuestion.answers.map((ele, i) => (
                                <MenuItem
                                  ...
                                  className={classes.textCapitalize}
                                  onClick={() => {
                                    onSelectAnswer(ele, dropDownNextQuestion)
                    ...
                    currentQuestion?.answers.map((ele, i) => {
                      return (
                        ...
                        >
                          <Segment
                            className={
                              selectedQA?.filter((data) => ele?.id === data?.id)
                                ?.length > 0
